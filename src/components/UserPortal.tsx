                                    ...
                                    {order.deliveryMethod === 'delivery' ? (
                                      <div className="p-4 rounded-2xl bg-neutral-50 dark:bg-neutral-950 border border-neutral-200/40 dark:border-neutral-800/40 space-y-4">
                                        <div className="flex items-center gap-3">
                                          ...
                                          <div>
                                            <h5 className="text-xs font-black text-neutral-900 dark:text-white">Olart Dispatch Service</h5>
                                      ...
                                      <div className="p-4 rounded-2xl bg-neutral-50 dark:bg-neutral-950 border border-neutral-200/40 dark:border-neutral-800/40 space-y-4">
                                        <div className="flex items-center gap-3">
                                          ...
                                          <div>
                                            <h5 className="text-xs font-black text-neutral-900 dark:text-white">Olart Kitchen Collection Point</h5>
